...
import { Color, GameState, PeerMessage, GameMode } from './types';
import { 
...
const STORAGE_KEY = 'catur_ceria_v3';
    ...
    return (
      <div className="min-h-screen bg-emerald-50 flex flex-col items-center justify-center p-6 text-center">
        <div className="bg-white p-10 rounded-[40px] shadow-2xl border-8 border-emerald-500 max-w-md w-full space-y-8 animate-in fade-in zoom-in duration-500">
          ...
          <h1 className="text-4xl font-black text-emerald-800">CATUR CERIA</h1>
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <div className="text-left">
                <p className="font-black text-xl">MAIN LOKAL</p>
                <p className="text-xs opacity-80">1 HP untuk berdua</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <p className="font-black text-xl">MAIN ONLINE</p>
                <p className="text-xs opacity-80">2 HP berjauhan</p>
              </div>
            </button>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-emerald-50 flex flex-col items-center p-4 md:p-8 select-none">
      ...
      <main className="w-full max-w-[1400px] grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-emerald-100">
             ...
             {isOnlineMode ? (
               <div className="space-y-3">
                  <div className={`p-4 rounded-2xl border-2 flex items-center justify-between ${localReady ? 'bg-green-50 border-green-400' : 'bg-gray-50 border-gray-200'}`}>
               ...
               <div className="bg-blue-50 p-5 rounded-2xl text-center">
                  ...
                  <p className="text-xs text-blue-600">Main gantian di HP ini ya!</p>
               </div>
             )}
          </div>
        ...
        {/* Center Column: Board - Taking more horizontal space if possible */}
             ...
             {!isBothReady && isOnlineMode && (
               <div className="absolute inset-0 z-50 flex items-center justify-center">
                  <div className="bg-white px-8 py-6 rounded-3xl shadow-2xl border-8 border-emerald-500 text-center animate-bounce">
                     <p className="font-black text-2xl text-emerald-800">KLIK "SIAP" DULU!</p>
                  </div>
               </div>
             )}
          </div>
        ...
        <div className="lg:col-span-1 space-y-4">
           <div className="bg-white p-6 rounded-3xl shadow-xl border-4 border-orange-100 h-[400px] flex flex-col">
              <h3 className="font-black text-orange-800 text-xl mb-4">Langkah</h3>
        ...
        <div className="fixed inset-0 bg-emerald-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white max-w-lg w-full rounded-[50px] shadow-2xl overflow-hidden border-[12px] border-emerald-500 animate-in fade-in zoom-in duration-300">
            <div className="p-10 space-y-8 text-center">
              <h2 className="text-4xl font-black text-emerald-800 uppercase">Halo Jagoan!</h2>
              ...
              <button onClick={() => setShowTutorial(false)} className="w-full bg-emerald-500 text-white font-black py-5 rounded-3xl hover:bg-emerald-600 transition-all text-2xl shadow-xl active:scale-95">MENGERTI!</button>
            </div>
          </div>
        </div>
      )}
